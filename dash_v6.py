...
# --- CARGA ---
try:
    ligie, hts, sec301, metals_db, tmec, part, aranceles, auxiliar, sec122, auto_db, mhdv_db, wood_db, semi_db = load_data(target_country)
except Exception as e:
            ...
            if not hts_filtrado.empty:
                ...
                for code in unique_hts_codes:
                    ...
                    if not children.empty:
                        ...
                        if len(unique_metal_duties) == 1:
                            ...
                            if shared_duty in [50.0, 25.0, "Annex III"]:
                        ...
                        if match_code:
                            has_metals_match = True
                            if duty in [50.0, 25.0, "Annex III"]:
                ...
                if wizard_queue:
                    ...
                    with st.expander(w_title, expanded=st.session_state.wizard_expanded):
                        ...
                        # Variables independientes para que no choquen si existen ambas
                        ...
                        with col_wiz_2:
                            ...
                            if c_next.button(btn_label, use_container_width=True, type="primary"):
                                ...
                                # Guardamos los resultados independientes en session_state
                                if metals_task:
