...
<details style='margin-bottom: 5px;'>
<summary style='color: #73c6e3; font-size: 1.2rem; font-weight: bold; cursor: pointer;'><a href='https://www.whitehouse.gov/presidential-actions/2026/02/imposing-a-temporary-import-surcharge-to-address-fundamental-international-payments-problems/' target='_blank' style='color: inherit; text-decoration: none;'>Sección 122 (No Vigente)</a></summary>
<div style='padding-left: 15px;'>
...
<details style='margin-bottom: 5px;'>
<summary style='color: #73c6e3; font-size: 1.2rem; font-weight: bold; cursor: pointer;'>Sección 232 (6 sectores)</summary>
...
<li>Artículos Farmacéuticos (Pharma)</li>
</ol>
</div>
...
<details style='margin-bottom: 5px;'>
<summary style='color: #2596be; font-weight: bold; cursor: pointer;'><a href='https://www.whitehouse.gov/presidential-actions/2026/04/adjusting-imports-of-pharmaceuticals-and-pharmaceutical-ingredients-into-the-united-states/' target='_blank' style='color: inherit; text-decoration: none;'>6. Artículos Farmacéuticos (Pharma)</a></summary>
<div style='padding: 10px; color: #475569; font-size: 0.9rem;'>
<ul style="margin-top: 5px; margin-bottom: 0px;">
<li><b>Vigencia:</b>
<ul style="list-style-type: circle; margin-top: 5px;">
<li><b>Proclamación:</b> 2 de abril de 2026.</li>
<li><b>Entrada en vigor acelerada:</b> 31 de julio de 2026 para las empresas del <a href='https://www.whitehouse.gov/wp-content/uploads/2026/04/Pharmaceuticals-Imports-ANNEXES-I-II-III-IV.pdf' target='_blank' style='color: #2596be; text-decoration: none;'>Anexo II</a>.</li>
<li><b>Resto de empresas:</b> 29 de septiembre de 2026.</li>
</ul>
</li>
<li><b>Arancel Base:</b> 100% ad valorem.</li>
<li><b>Onshoring:</b> En caso de contar con un plan de onshoring, la tasa disminuye al 20% (se restablece la tasa de 100% el 2 de abril de 2030).
<ul style="list-style-type: circle; margin-top: 5px;">
<li><b>Acuerdo de Precios:</b> Si además, se tiene establecido un plan de precios con el Secretario de Comercio, la tasa se reduce a 0% (vigente hasta el 20 de enero de 2029).</li>
</ul>
</li>
<li><b>Exenciones:</b> Medicamento Genérico o Biosimilar, Especialidad Médica Autorizada, Acondicionamiento Final en EUA, o Uso no Farmacéutico.</li>
</ul>
</div>
</details>
...
<details style='margin-bottom: 5px;'>
<summary style='color: #73c6e3; font-size: 1.2rem; font-weight: bold; cursor: pointer;'>Sección 301 (Trabajo Forzoso y Prácticas Desleales)</summary>
<div style='padding-left: 15px; padding-top: 5px;'>             

<details style='margin-bottom: 5px;'>
<summary style='color: #2596be; font-weight: bold; cursor: pointer;'><a href='https://www.whitehouse.gov/presidential-actions/2026/07/actions-by-the-united-states-in-the-investigations-under-section-301-of-the-trade-act-of-1974-of-the-acts-policies-and-practices-of-60-economies-related-to-the-failure-of-each-economy-to-impose-and/' target='_blank' style='color: inherit; text-decoration: none;'>1. Trabajo Forzoso</a></summary><div style='padding: 10px; color: #475569; font-size: 0.9rem;'>
<ul style="margin-top: 5px; margin-bottom: 0px;">
<li><b>Arancel Acumulativo:</b> Se aplica a partir del 24 de julio de 2026. Es acumulativo con la tasa general y otras medidas de la Sección 232. En el caso de China, se suma a la Sección 301 previa.</li>
<li><b>Arancel China:</b> 12.5% ad valorem.</li>
<li><b>Arancel México:</b> 10% ad valorem. (Exento si califica como libre de arancel bajo el T-MEC).</li>
<li><b>Exenciones Específicas:</b> Artículos listados explícitamente como excepciones, partes de aeronaves (Aircraft) y artículos para aplicaciones farmacéuticas (Pharma).</li>
</ul>
</div>
</details>

<details style='margin-bottom: 5px;'>
<summary style='color: #2596be; font-weight: bold; cursor: pointer;'><a href='https://hts.usitc.gov/reststop/file?release=currentRelease&filename=China%20Tariffs' target='_blank' style='color: inherit; text-decoration: none;'>2. Prácticas Desleales</a></summary>
<div style='padding: 10px; color: #475569; font-size: 0.9rem;'>
<ul style="margin-top: 5px; margin-bottom: 0px;">
...
def load_data(target_country="China"):
    ...
    # FLIP 301 (Reemplaza Sec 122)
    flip301 = pd.read_parquet(f'{base_path}flip_301.parquet')
    flip301 = normalize_cols(flip301)
    if 'code' in flip301.columns:
        flip301 = clean_numeric_code(flip301, 'code')

    # PHARMA (Sec 232)
    pharma_db = pd.read_parquet(f'{base_path}pharma.parquet')
    pharma_db = normalize_cols(pharma_db)
    if 'code' in pharma_db.columns:
        pharma_db = clean_numeric_code(pharma_db, 'code')
        pharma_db.rename(columns={'code': 'Code', 'annex': 'Annex'}, inplace=True)

    # NUEVAS EXCEPCIONES SEC 232 (Auto, MHDV, Wood, Semi)
    ...
    return ligie, hts, sec301, metals_db, tmec, rvc_db, part, aranceles, auxiliar, flip301, pharma_db, auto_db, mhdv_db, wood_db, semi_db
...
def get_pharma_match(hts_8, pharma_db):
    hts_str = str(hts_8).strip()
    for length in [10, 8, 7, 6, 5, 4]:
        sub = hts_str[:length]
        matches = pharma_db[pharma_db['Code'] == sub]
        if not matches.empty:
            return sub, matches.iloc[0].get('Annex', '')
    return None, None

def get_10digit_children_pharma(hts_8_digit, pharma_db, auxiliar_db):
    hts_8 = str(hts_8_digit).strip()
    children_pharma = pharma_db[
        (pharma_db['Code'].str.len() == 10) & 
        (pharma_db['Code'].str.startswith(hts_8))
    ].copy()
    
    if children_pharma.empty: 
        return pd.DataFrame()
    ...
    if all_children.empty:
        children_pharma['Description'] = children_pharma['Code'] + " - Opción específica"
        return children_pharma[['Code', 'Annex', 'Description']]
        
    pharma_unique = children_pharma[['Code', 'Annex']].drop_duplicates('Code')
    merged = all_children.merge(pharma_unique, on='Code', how='left')
    merged['Annex'] = merged['Annex'].fillna("")
    merged['Description'] = merged['Code'] + " - " + merged['Description'].fillna("Descripción no disponible")
...
# --- CARGA ---
try:
    ligie, hts, sec301, metals_db, tmec, rvc_db, part, aranceles, auxiliar, flip301, pharma_db, auto_db, mhdv_db, wood_db, semi_db = load_data(target_country)
except Exception as e:
...
if 'user_tmec_general_decisions' not in st.session_state: st.session_state.user_tmec_general_decisions = {}
...
if 'user_flip301_decisions' not in st.session_state: st.session_state.user_flip301_decisions = {}
...
if 'user_pharma_decisions' not in st.session_state: st.session_state.user_pharma_decisions = {}
...
if hs6_input != st.session_state.last_search:
    ...
    st.session_state.user_tmec_general_decisions = {}
    st.session_state.user_metals_decisions = {}
    st.session_state.user_tmec_metals_decisions = {}
    st.session_state.user_flip301_decisions = {}
    ...
    st.session_state.user_pharma_decisions = {}
        ...
        if apply_us:
            ...
            if not hts_filtrado.empty:
                ...
                for code in unique_hts_codes:
                    ...
                    wizard_queue_dict[code] = {'hts_8': code, 'tmec_general_task': None, 'metals_task': None, 'flip301_task': None, 'auto_task': None, 'tmec_auto_task': None, 'mhdv_task': None, 'tmec_mhdv_task': None, 'wood_task': None, 'semi_task': None, 'pharma_task': None}
                    
                    # --- LÓGICA COLA WIZARD PARA TMEC GENERAL ---
                    is_code_tmec = code in tmec_codes_clean_list
                    if is_code_tmec:
                        wizard_queue_dict[code]['tmec_general_task'] = True
                    ...
                    # --- LÓGICA COLA WIZARD PARA FLIP 301 (Sec 301 Labor) ---
                    match_flip = flip301[flip301['code'] == code]
                    
                    scope_val = ""
                    desc_val = ""
                    if not match_flip.empty:
                        scope_val = str(match_flip.iloc[0].get('scope', '')).lower()
                        desc_val = str(match_flip.iloc[0].get('description', ''))
                        
                    needs_wizard = False
                    task_dict = {'type': 'flip301', 'scope': scope_val, 'desc': desc_val}
                    
                    if 'ex' in scope_val or 'aircraft' in scope_val or 'pharma' in scope_val:
                        needs_wizard = True
                                
                    if needs_wizard:
                        wizard_queue_dict[code]['flip301_task'] = task_dict
                    else:
                        if code not in st.session_state.user_flip301_decisions:
                            # True significa que SÍ aplica el arancel
                            st.session_state.user_flip301_decisions[code] = True if match_flip.empty else False
                            
                    # --- LÓGICA COLA WIZARD PARA PHARMA ---
                    pharma_children = get_10digit_children_pharma(code, pharma_db, auxiliar)
                    if not pharma_children.empty:
                        unique_pharma_results = set()
                        for c_code in pharma_children['Code']:
                            m_code, m_annex = get_pharma_match(c_code, pharma_db)
                            unique_pharma_results.add(m_annex)
                        if len(unique_pharma_results) == 1:
                            shared_annex = unique_pharma_results.pop()
                            if str(shared_annex).strip().upper() == 'ANNEX I':
                                wizard_queue_dict[code]['pharma_task'] = {'type': 'direct', 'annex': shared_annex}
                            else:
                                st.session_state.user_pharma_decisions[code] = 0.0
                        else:
                            wizard_queue_dict[code]['pharma_task'] = {'type': '10_digit', 'children_df': pharma_children}
                    else:
                        match_pharma_code, pharma_annex = get_pharma_match(code, pharma_db)
                        if match_pharma_code:
                            if str(pharma_annex).strip().upper() == 'ANNEX I':
                                wizard_queue_dict[code]['pharma_task'] = {'type': 'direct', 'annex': pharma_annex}
                            else:
                                st.session_state.user_pharma_decisions[code] = 0.0
                ...
                wizard_queue = [v for v in wizard_queue_dict.values() if v['tmec_general_task'] or v['metals_task'] or v['flip301_task'] or v['auto_task'] or v['tmec_auto_task'] or v['mhdv_task'] or v['tmec_mhdv_task'] or v['wood_task'] or v['semi_task'] or v['pharma_task']]
                ...
                if wizard_queue:
                    ...
                    tmec_general_task = current_item['tmec_general_task']
                    metals_task = current_item['metals_task']
                    flip301_task = current_item['flip301_task']
                    ...
                    pharma_task = current_item['pharma_task']
                    
                    trigger_spaces = " " * st.session_state.get('wizard_close_trigger', 0)
                    
                    # Títulos dinámicos basados en la concurrencia de tareas
                    tasks_count = sum([1 for t in [tmec_general_task, metals_task, flip301_task, auto_task, tmec_auto_task, mhdv_task, tmec_mhdv_task, wood_task, semi_task, pharma_task] if t])
                    if tasks_count > 1:
                        ...
                        w_color = "#3b82f6"
                    elif tmec_general_task:
                        w_title_base = "⚠️ Clasificación Requerida: Origen TMEC"
                        w_msg = "Determine si su producto cumple con las reglas de origen específicas para aplicar la tasa preferencial TMEC."
                        w_color = "#10b981"
                    elif flip301_task:
                        w_title_base = "⚠️ Clasificación Requerida: Sec 301 Labor"
                        w_msg = "Seleccione las características del producto para determinar la exención de la Section 301 Labor."
                        w_color = "#008889"
                    elif pharma_task:
                        w_title_base = "⚠️ Clasificación Requerida: Sec 232 (Pharma)"
                        w_msg = "Seleccione las características del artículo farmacéutico para determinar el arancel."
                        w_color = "#ec4899"
                    elif auto_task:
                    ...
                    with st.expander(w_title, expanded=st.session_state.wizard_expanded):
                        ...
                        with col_wiz_1:
                            ...
                            elif pharma_task and pharma_task.get('type') == '10_digit' and not pharma_task['children_df'].empty:
                                shared_children_df = pharma_task['children_df']
                            ...
                            # --- 1.5 EVALUACIÓN GENERAL TMEC ---
                            ans_tmec_general = "No"
                            if tmec_general_task:
                                if has_previous_question: st.markdown("<hr style='margin: 15px 0;'>", unsafe_allow_html=True)
                                st.markdown(f"**Origen TMEC (Fracción {current_hts}):** ¿El producto reúne los requisitos para acceder al trato preferencial bajo el T-MEC? Verifique las condiciones aplicables en el <a href='https://dof.gob.mx/2020/SRE/T_MEC_290620.pdf' target='_blank'>enlace</a>.", unsafe_allow_html=True)
                                ans_tmec_general = st.radio("tmec_general", ["Sí", "No"], key=f"rad_tmec_gen_{current_hts}", label_visibility="collapsed")
                                has_previous_question = True
                                ...
                                if temp_auto_cat:
                                    ...
                                    if ans_auto_val == "Sí":
                                        ...
                                        if clean_cat == 'automobile':
                                            ...
                                            if is_code_tmec and ans_tmec_general == "Sí":
                            ...
                            if metals_task and not product_claimed_by:
                                ...
                                if active_annex is not None or pre_duty is not None:
                                    active_metals = True
                                    ...
                                    if meets_15_pct == "Menor al 15%":
                                        ...
                                        if usa_melted == "Igual o mayor a 85%":
                                            ...
                                            if active_annex == "Annex III":
                                                ...
                                                if (is_code_tmec and ans_tmec_general == "Sí") or is_code_rvc:
                            ...
                            # --- 6.5 EVALUACIÓN DE PHARMA (Jerarquía 6) ---
                            if pharma_task and not product_claimed_by:
                                active_pharma_annex = ""
                                if pharma_task['type'] == '10_digit':
                                    children_df = pharma_task['children_df']
                                    if shared_selected_desc:
                                        row_match = children_df[children_df['Description'] == shared_selected_desc]
                                        if not row_match.empty:
                                            selected_code = row_match.iloc[0]['Code']
                                            match_pharma_code, ph_annex = get_pharma_match(selected_code, pharma_db)
                                            if match_pharma_code:
                                                active_pharma_annex = str(ph_annex).strip().upper()
                                else:
                                    active_pharma_annex = str(pharma_task.get('annex', '')).strip().upper()

                                if active_pharma_annex == 'ANNEX I':
                                    active_pharma = True
                                    product_claimed_by = 'Pharma'
                                    if has_previous_question: st.markdown("<hr style='margin: 15px 0;'>", unsafe_allow_html=True)
                                    
                                    st.markdown(f"**Sec 232 Pharma (Fracción {current_hts}):** ¿El producto farmacéutico corresponde a alguna de las siguientes categorías?")
                                    pharma_opts = ["Medicamento Genérico o Biosimilar", "Especialidad Médica Autorizada", "Acondicionamiento Final en EUA", "Uso no Farmacéutico", "Ninguna de las anteriores"]
                                    ans_pharma_cat = st.radio("pharma_cat", pharma_opts, index=4, key=f"rad_pharma_cat_{current_hts}", label_visibility="collapsed")
                                    
                                    if ans_pharma_cat != "Ninguna de las anteriores":
                                        duty_pharma_result = 0.0
                                    else:
                                        st.markdown(f"**Sec 232 Pharma (Fracción {current_hts}):** ¿La compañía importadora cuenta con un plan de *onshoring* activo?")
                                        ans_pharma_onshore = st.radio("pharma_onshore", ["No", "Sí"], key=f"rad_pharma_onshore_{current_hts}", label_visibility="collapsed")
                                        if ans_pharma_onshore == "No":
                                            duty_pharma_result = 100.0
                                        else:
                                            st.markdown(f"**Sec 232 Pharma (Fracción {current_hts}):** ¿Cuenta con un acuerdo de precios aprobado con el Secretario de Comercio?")
                                            ans_pharma_agreement = st.radio("pharma_agreement", ["No", "Sí"], key=f"rad_pharma_agreement_{current_hts}", label_visibility="collapsed")
                                            if ans_pharma_agreement == "Sí":
                                                duty_pharma_result = 0.0
                                            else:
                                                duty_pharma_result = 20.0
                                else:
                                    duty_pharma_result = 0.0

                            # --- 7. EVALUACIÓN DE FLIP 301 (Sec 301 Labor) ---
                            if flip301_task:
                                active_232_duty_val = 0.0
                                for d_val in [duty_metals_result, duty_auto_result, duty_mhdv_result, duty_wood_result, duty_semi_result, duty_pharma_result]:
                                    try:
                                        active_232_duty_val += float(d_val)
                                    except:
                                        pass
                                
                                if active_232_duty_val > 0:
                                    duty_flip301_result = False
                                else:
                                    scope_val = flip301_task.get('scope', '')
                                    desc_val = flip301_task.get('desc', '')
                                    
                                    if 'ex' in scope_val or 'aircraft' in scope_val or 'pharma' in scope_val:
                                        if has_previous_question: st.markdown("<hr style='margin: 15px 0;'>", unsafe_allow_html=True)
                                        if 'ex' in scope_val:
                                            st.markdown(f"**Sec 301 Labor (Fracción {current_hts}):** ¿Su producto corresponde **exactamente** a la siguiente descripción?")
                                            st.info(desc_val)
                                        elif 'aircraft' in scope_val:
                                            st.markdown(f"**Sec 301 Labor (Fracción {current_hts}):** ¿El producto consiste en partes, componentes o ensamblajes de aeronaves civiles?")
                                        elif 'pharma' in scope_val:
                                            st.markdown(f"**Sec 301 Labor (Fracción {current_hts}):** ¿El producto consiste en artículos para uso en aplicaciones farmacéuticas (*articles that are for use in pharmaceutical applications*)?")
                                            
                                        ans_scope = st.radio("flip301_scope", ["No", "Sí"], key=f"rad_flip_{current_hts}", label_visibility="collapsed")
                                        if ans_scope == "Sí": duty_flip301_result = False
                                        else: duty_flip301_result = True
                                    else:
                                        duty_flip301_result = True

                        with col_wiz_2:
                            # Renderizado dinámico ocultando tarjetas excluidas por jerarquía
                            if metals_task and active_metals and product_claimed_by in [None, 'Metals']:
                                try:
                            ...
                            if flip301_task:
                                val_s_str = "Aplica" if duty_flip301_result else "Exento"
                                st.markdown(f"""
                                <div class="metric-container" style="padding: 10px; border-top: 4px solid #008889; text-align: center; margin-bottom: 15px;">
                                    <div class="metric-title" style="margin-bottom: 5px;">Sec 301 Labor</div>
                                    <div class="metric-value" style="font-size: 1.5rem;">{val_s_str}</div>
                                </div>
                                """, unsafe_allow_html=True)

                            if pharma_task and active_pharma and product_claimed_by in [None, 'Pharma']:
                                try:
                                    dph_val = float(duty_pharma_result)
                                    val_ph_str = f"{dph_val:.2f}%"
                                except: val_ph_str = str(duty_pharma_result)
                                st.markdown(f"""
                                <div class="metric-container" style="padding: 10px; border-top: 4px solid #ec4899; text-align: center; margin-bottom: 15px;">
                                    <div class="metric-title" style="margin-bottom: 5px;">Arancel Pharma</div>
                                    <div class="metric-value" style="font-size: 1.5rem;">{val_ph_str}</div>
                                </div>
                                """, unsafe_allow_html=True)
                                
                            if auto_task and active_auto and product_claimed_by in [None, 'Auto']:
                                try:
                            ...
                            if show_tmec_auto_card and active_auto and product_claimed_by in [None, 'Auto']:
                                try:
                            ...
                            if mhdv_task and active_mhdv and product_claimed_by in [None, 'MHDV']:
                                try:
                            ...
                            if show_tmec_mhdv_card and active_mhdv and product_claimed_by in [None, 'MHDV']:
                                try:
                            ...
                            if wood_task and active_wood and product_claimed_by in [None, 'Wood']:
                                try:
                            ...
                            if c_next.button(btn_label, use_container_width=True, type="primary"):
                                ...
                                if tmec_general_task:
                                    st.session_state.user_tmec_general_decisions[current_hts] = ans_tmec_general
                                if metals_task:
                                ...
                                if flip301_task:
                                    st.session_state.user_flip301_decisions[current_hts] = duty_flip301_result
                                if auto_task:
                                ...
                                if pharma_task:
                                    st.session_state.user_pharma_decisions[current_hts] = duty_pharma_result
                ...
                def calculate_metals_row(row):
                    ...
                    task = wizard_queue_dict.get(code, {}).get('metals_task')
                    base_duty = float(row.get('Math Base', 0.0))
                    duty = 0.0
                    
                    if task:
                        if task.get('type') == '10_digit' and not task.get('children_df').empty:
                            selected_code = task['children_df'].iloc[0]['Code']
                            _, duty = get_direct_matches(selected_code, metals_db)
                        elif task.get('type') == 'annex':
                            duty = task.get('annex_type')
                        elif task.get('type') == 'fixed_outside':
                            duty = task.get('duty')
                    else:
                        _, duty = get_direct_matches(code, metals_db)
                        
                    if duty in [50.0, 25.0]: return duty
                    elif duty == "Annex I-C": return 25.0
                    elif duty == "Annex III": return max(0.0, 15.0 - base_duty)
                    elif isinstance(duty, (int, float)): return duty
                ...
                def calculate_autos_base(row):
                    ...
                    task = wizard_queue_dict.get(code, {}).get('auto_task')
                    if task:
                        if task.get('type') == '10_digit' and not task.get('children_df').empty:
                            selected_code = task['children_df'].iloc[0]['Code']
                            _, duty, category = get_auto_match(selected_code, auto_db)
                            return pd.Series([duty, category])
                        elif task.get('type') == 'direct':
                            return pd.Series([task.get('duty', 0.0), task.get('category', '')])
                ...
                def calculate_mhdv_base(row):
                    ...
                    task = wizard_queue_dict.get(code, {}).get('mhdv_task')
                    if task:
                        if task.get('type') == '10_digit' and not task.get('children_df').empty:
                            selected_code = task['children_df'].iloc[0]['Code']
                            _, duty, category = get_mhdv_match(selected_code, mhdv_db)
                            return pd.Series([duty, category])
                        elif task.get('type') == 'direct':
                            return pd.Series([task.get('duty', 0.0), task.get('category', '')])
                ...
                def calculate_wood_base(row):
                    ...
                    task = wizard_queue_dict.get(code, {}).get('wood_task')
                    if task:
                        if task.get('type') == '10_digit' and not task.get('children_df').empty:
                            selected_code = task['children_df'].iloc[0]['Code']
                            _, duty, category = get_wood_match(selected_code, wood_db)
                            return pd.Series([duty, category])
                        elif task.get('type') == 'direct':
                            return pd.Series([task.get('duty', 0.0), task.get('category', '')])
                    ...
                    if not exact_match.empty:
                        return pd.Series([exact_match.iloc[0].get('Duty', 0.0), exact_match.iloc[0].get('Category', '')])
                ...
                def calculate_semi_row(row):
                    ...
                    task = wizard_queue_dict.get(code, {}).get('semi_task')
                    if task and task.get('type') == 'direct':
                        return task.get('duty', 0.0)
                ...
                # --- LÓGICA Sec 232 (Pharma) ---
                def calculate_pharma_row(row):
                    code = row['Code']
                    if wizard_queue and code == current_hts and pharma_task:
                        return duty_pharma_result
                    if code in st.session_state.user_pharma_decisions:
                        return st.session_state.user_pharma_decisions[code]
                        
                    task = wizard_queue_dict.get(code, {}).get('pharma_task')
                    if task:
                        if task.get('type') == '10_digit' and not task.get('children_df').empty:
                            # Previsualiza la tasa del primer hijo, empatando con el default del Wizard
                            selected_code = task['children_df'].iloc[0]['Code']
                            _, annex = get_pharma_match(selected_code, pharma_db)
                            return 100.0 if str(annex).strip().upper() == 'ANNEX I' else 0.0
                        elif task.get('type') == 'direct':
                            return 100.0 # Default if Annex I without wizard response
                        
                    match_code, annex = get_pharma_match(code, pharma_db)
                    if match_code and str(annex).strip().upper() == 'ANNEX I':
                        return 100.0
                    return 0.0

                hts_filtrado['Sec 232 (Pharma)'] = hts_filtrado.apply(calculate_pharma_row, axis=1)

                # --- LÓGICA Flip 301 (Sec 301 Labor) ---
                def calculate_flip301_applies(row):
                    code = row['Code']
                    if wizard_queue and code == current_hts and flip301_task:
                        return duty_flip301_result
                    if code in st.session_state.user_flip301_decisions:
                        return st.session_state.user_flip301_decisions[code]
                        
                    has_232 = (
                        float(row.get('Sec 232 (Metals)', 0.0)) > 0 or
                        float(row.get('Auto_Duty', 0.0)) > 0 or
                        float(row.get('MHDV_Duty', 0.0)) > 0 or
                        float(row.get('Wood_Duty', 0.0)) > 0 or
                        float(row.get('Sec 232 (Semiconductors)', 0.0)) > 0 or
                        float(row.get('Sec 232 (Pharma)', 0.0)) > 0
                    )
                    if has_232:
                        return False
                ...
                hts_filtrado['Flip_301_Applies'] = hts_filtrado.apply(calculate_flip301_applies, axis=1)
                ...
                # Función auxiliar para formatear la tasa Flip 301
                def format_flip301_duty_row(row, rate):
                    val = rate if row.get('Flip_301_Applies', True) else 0.0
                    try:
                ...
                def apply_hierarchy_china(row):
                    ...
                    pharma = float(row.get('Sec 232 (Pharma)', 0.0))

                    if semi > 0: auto = mhdv = metals = wood = pharma = 0.0
                    elif auto > 0: mhdv = metals = wood = pharma = 0.0
                    elif mhdv > 0: metals = wood = pharma = 0.0
                    elif metals > 0: wood = pharma = 0.0
                    elif wood > 0: pharma = 0.0
                    ...
                    row['Wood_Duty'] = wood
                    row['Sec 232 (Pharma)'] = pharma
                    return row

                hts_china = hts_china.apply(apply_hierarchy_china, axis=1)
                
                # 1. Aplicamos el formato de Sec 301 Labor (Flip 301) para China (12.5%)
                hts_china['Sec 301 Labor'] = hts_china.apply(lambda r: format_flip301_duty_row(r, 12.5), axis=1)
                hts_china.rename(columns={'Sec 301': 'Sec 301 China'}, inplace=True)
                
                def calc_total_row_china(row):
                    math_base = row['Math Base']
                    try: duty_metals = float(row['Sec 232 (Metals)'])
                    except: duty_metals = 0.0
                    try: sec301 = float(row['Sec 301 China'])
                    except: sec301 = 0.0
                    ...
                    try: duty_pharma = float(row.get('Sec 232 (Pharma)', 0.0))
                    except: duty_pharma = 0.0
                    
                    # 2. Lógica de suma de porcentajes
                    sec301labor_val = row.get('Sec 301 Labor', 12.5)
                    try: duty_301labor = float(str(sec301labor_val).replace('%', ''))
                    except: duty_301labor = 12.5 if row.get('Flip_301_Applies', True) else 0.0
                            
                    sum_pct = math_base + duty_metals + sec301 + duty_301labor + duty_autos + duty_mhdv + duty_wood + duty_semi + duty_pharma
                    fixed = row['Fixed']
                    
                    # 3. Construcción del arancel final
                ...
                format_dict_china = {'Sec 301 China': '{:.2f}%', 'Sec 301 Labor': smart_pct}
                ...
                if (hts_china['Sec 232 (Pharma)'] > 0).any():
                    cols_china.append('Sec 232 (Pharma)')
                    format_dict_china['Sec 232 (Pharma)'] = smart_pct
                ...
                # Agrupación Sec 301
                cols_china.append('Sec 301 Labor')
                cols_china.append('Sec 301 China')
                ...
                def evaluate_tmec_status(row):
                    is_tmec = row.get('is_tmec', False)
                    code = row['Code']
                    if is_tmec:
                        has_tmec_task = wizard_queue_dict.get(code, {}).get('tmec_general_task', False)
                        if wizard_queue and code == current_hts and has_tmec_task:
                            return ans_tmec_general == "Sí"
                        elif code in st.session_state.user_tmec_general_decisions:
                            return st.session_state.user_tmec_general_decisions[code] == "Sí"
                        # Proyección por defecto si la tarea general TMEC aún no ha sido respondida explícitamente por el usuario
                        return True
                    return False
                
                hts_mexico['is_tmec'] = hts_mexico.apply(evaluate_tmec_status, axis=1)
                ...
                def apply_hierarchy_mexico_base(row):
                    # 1. Determinamos la jerarquía usando los aranceles BASE (antes de aplicar los beneficios TMEC)
                    semi = float(row.get('Sec 232 (Semiconductors)', 0.0))
                    auto = float(row.get('Auto_Duty', 0.0))
                    mhdv = float(row.get('MHDV_Duty', 0.0))
                    metals = float(row.get('Sec 232 (Metals)', 0.0))
                    ...
                    row['Sec 232 (Semiconductors)'] = semi
                    row['Auto_Duty_Survivor'] = auto
                    row['MHDV_Duty_Survivor'] = mhdv
                    row['Metals_Duty_Survivor'] = metals
                    row['Wood_Duty'] = wood
                    row['Sec 232 (Pharma)'] = pharma
                    return row

                hts_mexico = hts_mexico.apply(apply_hierarchy_mexico_base, axis=1)

                def apply_flip301_mexico(row):
                    is_tmec = row.get('is_tmec', False)
                    raw_duty = str(row.get('Duty_TMEC', '')).lower()
                    if is_tmec and raw_duty in ['free', 'libre', '0', '0.0', '0%']:
                        return "0.00%"
                    # En caso contrario, format_flip301_duty_row con 10%
                    return format_flip301_duty_row(row, 10.0)
                    
                hts_mexico['Sec 301 Labor'] = hts_mexico.apply(apply_flip301_mexico, axis=1)

                def apply_autos_mexico(row):
                    # 2. Si la jerarquía descartó Auto desde el inicio, forzamos a 0
                    if row.get('Auto_Duty_Survivor', 0.0) == 0.0: return 0.0
                    
                    is_tmec = row.get('is_tmec', False)
                    duty = row.get('Auto_Duty_Survivor', 0.0)
                    ...
                    if is_tmec and category == 'autoparts':
                        if wizard_queue and code == current_hts and show_tmec_auto_card:
                            ...
                            # Proyección por defecto: El wizard asume que Knock-Down = "No", lo que anula el descuento TMEC y resulta en 0.0
                            return 0.0
                    return duty
                ...
                def apply_mhdv_mexico(row):
                    if row.get('MHDV_Duty_Survivor', 0.0) == 0.0: return 0.0
                    
                    is_tmec = row.get('is_tmec', False)
                    duty = row.get('MHDV_Duty_Survivor', 0.0)
                ...
                def apply_metals_tmec_mexico(row):
                    if row.get('Metals_Duty_Survivor', 0.0) == 0.0: return 0.0
                    
                    is_tmec = row.get('is_tmec', False)
                    is_rvc = row.get('is_rvc', False)
                    duty = float(row.get('Metals_Duty_Survivor', 0.0))
                    code = row['Code']
                ...
                def calc_total_row_mexico(row):
                    math_base = row.get('Math Base', 0.0)
                    try: duty_metals = float(row['Sec 232 (Metals)'])
                    except: duty_metals = 0.0
                    ...
                    # Lógica de suma de porcentajes
                    sec301labor_val = row.get('Sec 301 Labor', 10.0)
                    try: duty_301labor = float(str(sec301labor_val).replace('%', ''))
                    except: duty_301labor = 10.0 if row.get('Flip_301_Applies', True) else 0.0
                    
                    sum_pct = math_base + duty_metals + duty_301labor + duty_autos + duty_mhdv + duty_wood + duty_semi + duty_pharma
                    
                    if row.get('is_complex', False):
                        if sum_pct > 0:
                            return f"{row['General']}<br><span style='color: #dc2626; font-weight: bold;'>+ {sum_pct:.2f}%</span>"
                        return row['General']
                        
                    fixed = row.get('Fixed', None)
                    # Construcción del arancel final
                    if pd.notna(fixed) and fixed:
                        return f"{fixed} + {sum_pct:.2f}%" if sum_pct > 0 else fixed
                    
                    if str(row.get('General', '')).lower() == 'free' and sum_pct == 0:
                        return "Free"

                    return f"{sum_pct:.2f}%"

                hts_mexico['Total'] = hts_mexico.apply(calc_total_row_mexico, axis=1)
                hts_mexico['General'] = hts_mexico['General'].fillna("")
                hts_mexico['Fixed'] = hts_mexico['Fixed'].fillna("")
                
                cols_mexico = ['Code', 'Description']
                format_dict_mexico = {'Sec 301 Labor': smart_pct}
                
                if hts_mexico['General'].astype(str).str.strip().ne("").any():
                    cols_mexico.append('General')
                    
                if hts_mexico['Fixed'].astype(str).str.strip().ne("").any():
                    cols_mexico.append('Fixed')
                
                # Agrupación Sec 232 (Evaluamos dinámicamente qué columnas mostrar en México si su valor final es > 0)
                ...
                if (hts_mexico['Sec 232 (Pharma)'] > 0).any():
                    cols_mexico.append('Sec 232 (Pharma)')
                    format_dict_mexico['Sec 232 (Pharma)'] = smart_pct
                ...
                # Agrupación Sec 301
                cols_mexico.append('Sec 301 Labor')
