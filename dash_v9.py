        ...
        if apply_us:
            ...
            if not hts_filtrado.empty:
                ...
                for code in unique_hts_codes:
                    ...
                    wizard_queue_dict[code] = {'hts_8': code, 'tmec_general_task': None, 'metals_task': None, 'sec122_task': None, 'auto_task': None, 'tmec_auto_task': None, 'mhdv_task': None, 'tmec_mhdv_task': None, 'wood_task': None, 'semi_task': None}
                ...
                wizard_queue = [v for v in wizard_queue_dict.values() if v['tmec_general_task'] or v['metals_task'] or v['sec122_task'] or v['auto_task'] or v['tmec_auto_task'] or v['mhdv_task'] or v['tmec_mhdv_task'] or v['wood_task'] or v['semi_task']]
                ...
                if wizard_queue:
                    ...
                    tasks_count = sum([1 for t in [tmec_general_task, metals_task, sec122_task, auto_task, tmec_auto_task, mhdv_task, tmec_mhdv_task, wood_task, semi_task] if t])
                    if tasks_count > 1:
                ...
                # --- LÓGICA Sec 122 (Evaluada al final para permitir reclamos de otras jerarquías) ---
                def calculate_sec122_row(row):
                    ...
                    # Reclamo por jerarquías superiores para las fracciones pendientes
                    if row.get('Auto_Duty', 0.0) > 0 or row.get('MHDV_Duty', 0.0) > 0 or row.get('Wood_Duty', 0.0) > 0 or row.get('Sec 232 (Semiconductors)', 0.0) > 0:
                        return 0.0
