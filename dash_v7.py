                                            ...
                                            if active_annex == "Annex III":
                                                ...
                                                if is_code_tmec or is_code_rvc:
                                                    ...
                                                    if ans_rvc == "Sí":
                                                        ...
                                                        st.markdown("<hr style='margin: 15px 0;'>", unsafe_allow_html=True)
                                                        st.markdown(f"**Metales TMEC (Fracción {current_hts}):** Seleccione el porcentaje de contenido estadounidense respecto al valor total del producto:")
                                                        us_content = st.slider("US Content %", min_value=0, max_value=100, value=0, step=1, key=f"num_us_content_{current_hts}", label_visibility="collapsed")
